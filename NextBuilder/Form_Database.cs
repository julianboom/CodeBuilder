...
namespace NextBuilder
{
    public partial class Form_Database : WeifenLuo.WinFormsUI.Docking.DockContent
    {
        ...
        public void ShowCode()
        {
            ...
            if (Nodes.Count == 0)
            {
                var selNode = MainForm.form_Database.tvDatabase.SelectedNode;
        ...
        public List<TreeNode> GetTreeView1Selected()
        {
            ...
            TreeNodeCollection rootNodes = tvDatabase.Nodes;
        ...
        private void tvDatabase_DoubleClick(object sender, EventArgs e)
        {
            ...
            this.tvDatabase.BeginInvoke(addnode, false);
        }
